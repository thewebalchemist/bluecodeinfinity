...
const caseStudiesDirectory = path.join(process.cwd(), 'caseStudies')

export function getSortedCaseStudies() {
  // Get file names under /caseStudies
    ...
    // Sort caseStudies by date
    return caseStudies.sort(({ date: a }, { date: b }) => {
        if (a < b) {
        return 1
        } else if (a > b) {
        return -1
